#test_negative_create_review.py
import requests
...
def test_create_review_nonexistent_movie(api_manager):
    response = api_manager.reviews_api.create_review(99999999, rating=5, text="Test")
...
def test_create_review_duplicate(api_manager, movie_payload):
    ...
    # второй раз — ошибка
    response2 = api_manager.reviews_api.create_review(movie_id, **payload)
